...
try:
    from core_cres.crestereo import CREStereo
except ImportError:
    import os
...
class RaftTrainer(DDPTrainer):
    def __init__(self):
        ...
        args.restore_ckpt = "checkpoints/latest_CREStereo.pth"
        args.n_gru_layers = 3
        args.n_downsample = 2
        args.batch_size = 3
    ...
    def init_models(self) -> Module:
        model = CREStereo(mixed_precision=True).to(self.device)
